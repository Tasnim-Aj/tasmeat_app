...
import '../../bloc/hadiths/hadiths_bloc.dart';
import 'hadith_screen.dart';

class IndexingScreen extends StatelessWidget {
  final int bookId;

  IndexingScreen({super.key, required this.bookId});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        final bloc =
            HadithsBloc(hadithsRepository: HadithsRepository(BooksService()));
        bloc.add(LoadedAllHadiths(bookId: bookId));
        return bloc;
      },
      child: Directionality(
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<HadithsBloc, HadithsState>(
            builder: (context, state) {
              if (state is HadithsError) {
